...
const STEPS: TourStep[] = [
  ...
  { id: "checklist",        title: "Die To-Do Liste",          text: "Ihre To-Do Liste gibt Ihnen Hinweise, was noch zu erledigen ist. Hier werden unter anderem aktive Aufträge oder andere Aufgaben angezeigt.", target: "[data-tour='checklist']", placement: "right" },
  ...
  { id: "nav-earnings",     title: "Einnahmen",                text: "Eine detaillierte Übersicht Ihrer Einnahmen und Auszahlungen finden Sie unter diesem Menüpunkt.", target: "[data-tour='nav-earnings']", placement: "right" },
